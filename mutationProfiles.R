...
#' @description Plot all snvs found in a given gene. A 'gene_lengths' file must be provided with the following fields (cols 1..6 required)
...
geneEnrichment <- function(gene_lengths="data/gene_lengths.txt", n=1, genome_length=118274340){
  gene_lengths<-read.delim(gene_lengths, header = T)
  data<-getData()
